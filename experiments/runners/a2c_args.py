def add_a2c_args(parser):
    ...
    parser.add_argument('--network', type=str, default="lstm", help="policy network architecture. Either string (mlp, lstm, lnlstm, cnn_lstm, cnn, cnn_small, conv_only - see baselines.common/models.py for full list)"
